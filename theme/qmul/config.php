...
$THEME->layouts = array(
    ...
    'base' => array(
        'file' => 'default.php',
        'regions' => array('footer-left', 'landingpage', 'footer-middle', 'footer-right', 'widgets'),
        'defaultregion' => 'footer-left',
        'options' => array('nonavbar' => true),
    ),
    // Standard layout with blocks, this is recommended for most pages with general information.
    'standard' => array(
        'file' => 'default.php',
        'regions' => array('side-post', 'landingpage', 'widgets'),
        'defaultregion' => 'side-post',
    ),
    // Main course page.
    'course' => array(
        'file' => 'default.php',
        'regions' => array('side-post', 'landingpage', 'widgets','topiczero'),
        'defaultregion' => 'side-post',
