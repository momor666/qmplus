...
?>
    ...
    <div class="moodlecontent">
        <?php
            ...
            if (!isset($PAGE->layout_options['nonavbar']) || $PAGE->layout_options['nonavbar'] == false && !empty($navbar)) { ?>
                <?php echo $OUTPUT->context_header(); ?>
                <?php if ($COURSE->format != 'landingpage') { ?>
                ...
                <div class="courseheader mb-1 col-12">
                    <div class="row">
                        ...
                        <div class="summary p-1 d-block">
                            <?php
                                echo $OUTPUT->course_news();
                                //echo html_writer::tag('div', format_text($course->summary, $course->summaryformat));
                            ?>
                        </div>
                    </div>
                </div>
