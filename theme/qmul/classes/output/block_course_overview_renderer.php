 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_qmul_block_course_overview_renderer extends block_course_overview_renderer {
    /**
    ...
    public function course_overview($courses, $overviews) {
        ...
        foreach ($courses as $key => $course) {
            ...
            $html .= $this->output->box_start('coursebox testing', "course-{$course->id}");
            ...
            if (!$ismovingcourse && isset($overviews[$course->id])) {
