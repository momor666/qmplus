/**
 * Gruntfile for compiling theme_qmul .less files.
 *
...
var DEBUG = !!grunt.option('dbug');
    ...
    grunt.initConfig({
        ...
        exec: {
            ...
            decache: 'vagrant ssh -c "cd /var/www/html/development/qmul/ && sudo -u www-data /usr/bin/php admin/cli/purge_caches.php"'
        }
    });
