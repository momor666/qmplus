...
function theme_qmul_science_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    global $CFG;
...
function theme_qmul_science_page_init(moodle_page $page) {
