...
/**
 * Local qmframework sync user's dashboard abandon event
 *
...
class user_dashboard_sync_abandoned extends user_dashboard_sync {
     ...
     * @return user_dashboard_sync_abandoned event
     */
    public static function abandon_sync($userid, $maharauserdashboard) {
        $other = ['info' => 'Mahara user already has a copy of the qmdashboard.', 'details' => $maharauserdashboard];
