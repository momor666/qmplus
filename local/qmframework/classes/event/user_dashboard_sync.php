...
/**
 * Local qmframework sync user's dashboard event
 *
...
class user_dashboard_sync extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('syncuserdashboardevent', 'local_qmframework');
    }
    ...
    public function get_description() {
        $details = $this->objectid . '". Details: ' . json_encode($this->other);
        return 'Attempted to create the Mahara QM Framework Dashboard for Moodle user: "' . $details;
    }
     ...
     * @return user_dashboard_sync event
     */
    public static function create_sync($userid, $status, $other) {
