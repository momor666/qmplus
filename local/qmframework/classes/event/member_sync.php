...
/**
 * Local qmframework sync new group member event
 *
...
class member_sync extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('syncmemberevent', 'local_qmframework');
    }
    ...
    public function get_description() {
        ...
        return 'Attempted to sync groups_members: "' . $this->objectid . '" to mahara. ' . $details;
    }

    /**
     * Create instance of event.
     *
     * @param integer $memberid the ID of the groups_members synced.
     ...
     */
    public static function create_sync($memberid, $status, $other) {
