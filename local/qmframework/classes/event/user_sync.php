...
/**
 * Local qmframework sync new enrolled user event
 *
...
class user_sync extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('syncuserevent', 'local_qmframework');
    }
    ...
    public function get_description() {
        ...
        return 'Attempted to sync user: "' . $this->objectid . '" to mahara. ' . $details;
    }
