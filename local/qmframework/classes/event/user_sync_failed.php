...
/**
 * Local qmframework sync new enrolled user fail event
 *
...
class user_sync_failed extends user_sync {
     ...
     * @return user_sync_failed event
     */
    public static function fail_sync($userid, $error) {
        $other = ['info' => 'Create Mahara user error', 'error' => $error];
