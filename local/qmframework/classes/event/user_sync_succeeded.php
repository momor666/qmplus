...
/**
 * Local qmframework sync new enrolled user success event
 *
...
class user_sync_succeeded extends user_sync {
     ...
     */
    public static function success_sync($userid, $maharauser) {
        $other = ['info' => 'Mahara user created.', 'mahara_user' => $maharauser];
