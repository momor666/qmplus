...
$string['auth_syncauth'] = 'Authentication to sync to';
$string['auth_syncauth_desc'] = 'Select the authentication method that you want users mapped to.';
$string['pluginname'] = 'External database (sync to other)';
$string['auth_description'] = 'This allows Moodle to synchronise against an external database but create accounts as another '.
    'authentication type. For example when using Shibboleth or SSO which cannot synchronise itself.';
$string['auth_dbsyncotherdescription'] = 'This is the settings page for dbsync other, a plugin that allows Moodle to synchronise against an external database but create accounts as another
    authentication type. For example when using Shibboleth or SSO which cannot synchronise itself.';
$string['auth_dbignoreolduser'] = 'Old user in Moodle: user {$a->name} id {$a->id}. Do not revive or recreate (add).';
$string['auth_reviveuserconfigdesc'] = 'This settings allows you to bypass the automatic revival of old users in the synchronisation script. If set to yes
 and the script encounters any users in the feed that are also found to be users that have been either suspended or deleted in the moodle database ,
 then the users will be revived. Otherwise, when set to no, the user will be left suspended.';
$string['auth_reviveuserconfig'] = 'Revive old users';