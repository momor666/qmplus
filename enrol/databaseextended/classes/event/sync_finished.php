 ...
 */
class sync_finished extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('sync_finished', 'enrol_databaseextended');
    }
    ...
    public function get_description() {
        return "A sync ended for the databaseextended plugin";
    }
