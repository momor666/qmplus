...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('enrol_cohortcateg/dbtype', get_string('dbtype', 'enrol_cohortcateg'), get_string('dbtype_desc', 'enrol_cohortcateg'), $CFG->mis_dbtype , $options));

    $settings->add(new admin_setting_configtext('enrol_cohortcateg/dbhost', get_string('dbhost', 'enrol_cohortcateg'), get_string('dbhost_desc', 'enrol_cohortcateg'), $CFG->mis_host));

    $settings->add(new admin_setting_configtext('enrol_cohortcateg/dbuser', get_string('dbuser', 'enrol_cohortcateg'), '', $CFG->mis_user));

    $settings->add(new admin_setting_configpasswordunmask('enrol_cohortcateg/dbpass', get_string('dbpass', 'enrol_cohortcateg'), '', $CFG->mis_pass));

    $settings->add(new admin_setting_configtext('enrol_cohortcateg/dbname', get_string('dbname', 'enrol_cohortcateg'), get_string('dbname_desc', 'enrol_cohortcateg'), $CFG->mis_dbase));
