...
class enrol_cohortcateg_plugin extends enrol_plugin {
    ...
    public function db_init() {
        ...
        if (!$extdb->IsConnected()) {
            // CS trasition to common MIS configuration
            if(isset($CFG->mis_host) && isset($CFG->mis_dbase) && isset($CFG->mis_user) && isset($CFG->mis_pass) ){
                $result = $extdb->Connect($CFG->mis_host, $CFG->mis_user, $CFG->mis_pass, $CFG->mis_dbase, true);
            } else {
