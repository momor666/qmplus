...
/** 
 * Strings for component 'gradeimport_pearsonjson', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   gradeimport_pearsonjson
 * @copyright 1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */ 

$string['errbadpearsonjsonformat'] = 'Error - bad pearsonjson format';
...
$string['pluginname'] = 'Sync Pearson Custom Grades';
$string['directpearsonjson:publish'] = 'Publish import grades from pearsonjson';
$string['directpearsonjson:view'] = 'Import grades from pearsonjson';
$string['pagetitle'] = 'Sync Pearson Custom Grades';
