...
$url = new moodle_url('/grade/import/directpearsonjson/import.php', array('id'=>$id,'url'=>$url));
if ($feedback !== 0) {
...
$error = '';
$importcode = import_pearsonjson_grades($text, $course, $error);
...
if ($importcode !== false) {
    ...
    if (defined('USER_KEY_LOGIN')) {
        ...
        print_grade_page_head($course->id, 'import', 'pearsonjson', get_string('importpearsonjson', 'grades'));
    ...
    print_error('error', 'gradeimport_pearsonjson');
}
