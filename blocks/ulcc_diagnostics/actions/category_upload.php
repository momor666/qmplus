...
require_once($CFG->dirroot . '/blocks/ulcc_diagnostics/actions/admin_upload_category_form.php');
...
$PAGE->set_url('/blocks/ulcc_diagnostics/actions/category_upload.php');
...
$form_controller->setAction('form1', 'admin_upload_category_form', 'admin_upload_category_form_intermediate');
$form_controller->setAction('form2', 'admin_upload_category_form_intermediate', 'admin_upload_category_form_final');
$form_controller->setAction('form3', 'admin_upload_category_form_final', false);
