...
class ilp_plugin {
	...
	*/
     ...
     */
	 function config_text_element(&$mform,$elementname,$label,$description,$defaultvalue='',$elementtype=PARAM_RAW) {
         ...
         $mform->setType("s_{$elementname}", $elementtype);
 	 }
     ...
     */
    function config_htmleditor_element(&$mform,$elementname,$label,$description,$defaultvalue='',$elementtype=PARAM_RAW) {
     ...
     * @param mixed $defaultvalue the default contents of the text element 
     */
	 function config_select_element(&$mform,$elementname,$options,$label,$description,$defaultvalue='',$elementtype=PARAM_RAW) {
     ...
     * @param mixed $defaultvalue the default contents of the text element 
     */
	 function config_date_element(&$mform,$elementname,$label,$description,$defaultvalue='',$elementtype=PARAM_RAW) {
