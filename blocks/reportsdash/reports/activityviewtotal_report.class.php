...
global $PAGE;
class block_reportsdash_activityviewtotal_report extends block_reportsdash_report
{
...
//webservice is array of fields only output for the webservice
    protected static function fields()
    {
        ...
        return (object)array('outputs'=>array(new Reportdash_field_info('coursename',PARAM_TEXT,'Course name'),
            new Reportdash_field_info('total',PARAM_INT,'Total activities')),
    ...
    protected function setSql($usesort=true)
    {
        ...
        if ($selectreaders) {
            ...
            if ($reader->is_logging())   {
                ...
                $sql="  SELECT c.id, c.fullname as coursename, COUNT(DISTINCT l.id) AS total
