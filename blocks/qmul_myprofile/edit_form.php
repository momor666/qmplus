 ...
 */
class block_qmul_myprofile_edit_form extends block_edit_form
{

    protected function specific_definition($mform)
    {
        global $CFG;
        $mform->addElement('header', 'configheader', get_string('myprofile_settings', 'block_qmul_myprofile'));

        $mform->addElement('selectyesno', 'config_display_picture', get_string('display_picture', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_country', get_string('display_country', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_city', get_string('display_city', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_email', get_string('display_email', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_un', get_string('display_un', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_icq', get_string('display_icq', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_skype', get_string('display_skype', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_yahoo', get_string('display_yahoo', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_aim', get_string('display_aim', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_msn', get_string('display_msn', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_phone1', get_string('display_phone1', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_phone2', get_string('display_phone2', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_institution', get_string('display_institution', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_address', get_string('display_address', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_firstaccess', get_string('display_firstaccess', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_lastaccess', get_string('display_lastaccess', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_currentlogin', get_string('display_currentlogin', 'block_qmul_myprofile'));
        ...
        $mform->addElement('selectyesno', 'config_display_lastip', get_string('display_lastip', 'block_qmul_myprofile'));
        ...
        //display_smartlink
        $mform->addElement('selectyesno', 'config_display_smartlink', get_string('display_smartlink', 'block_qmul_myprofile'));
        if (isset($this->block->config->display_smartlink)) {
            $mform->setDefault('config_display_smartlink', $this->block->config->display_smartlink);
        } else {
            $mform->setDefault('config_display_smartlink', '0');
        }
    }
