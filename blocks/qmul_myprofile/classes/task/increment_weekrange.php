...
File:     /block/qmul_myprofile/classes/task/increment_weekrange.php
 ...
 */
namespace block_qmul_myprofile\task;

class increment_weekrange extends \core\task\scheduled_task
{
    public function get_name() {
        return get_string('increment_weekrange', 'block_qmul_myprofile');
    }

    public function execute() {
        //get module_info config
        $autoincrement_enabled = get_config('qmul_myprofile', 'autoincrementweek');
        if(!$autoincrement_enabled){
            return;
        }

        $config = get_config('qmul_myprofile', 'week');
        $new_config = '';
        ...
        if($new_config) {
            set_config('week', $new_config, 'qmul_myprofile');
        }
    }
    //preg callbacks
