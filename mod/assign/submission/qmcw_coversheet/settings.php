...
$settings->add(new admin_setting_configcheckbox('assignsubmission_qmcw_coversheet/default',
    new lang_string('default', 'assignsubmission_qmcw_coversheet'),
    new lang_string('default_help', 'assignsubmission_qmcw_coversheet'), 0));
