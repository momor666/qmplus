...
/**
 * class for displaying configlog type form.
 *
 * @copyright  2015 Queen Mary University of London
 * @author     Panagiotis Paralakis  <p.paralakis@qmul.ac.uk>
 */
class report_qmplus_configlog_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('html', "<h2>".get_string('configlogtitle', 'report_qmplus')."</h2>");
        $mform->addElement('html', "<p>".get_string('configlogreportsdesc', 'report_qmplus')."</p>");
        ...
        $mform->addElement(
            'submit',
            'submitbutton',
            get_string('getreport', 'report_qmplus'),
            array('id'=>'configlogsubmit')
        );
