 ...
 * @author     Panagiotis Paralakis  <p.paralakis@qmul.ac.uk>
 */
class report_qmplus_backup_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('html', "<h2>".get_string('backuptitle', 'report_qmplus')."</h2>");
        $mform->addElement('html', "<p>".get_string('backupreportsdesc', 'report_qmplus')."</p>");
