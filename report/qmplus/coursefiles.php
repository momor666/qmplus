...
require(dirname(__FILE__).'/coursefiles_form.php');

require_login();

// Get URL parameters.
$requestedType = optional_param('course', '', PARAM_SAFEDIR);
...
if (has_capability('report/qmplus:view', context_system::instance())) {
    ...
    $mform = new report_qmplus_coursefiles_form();
...
?>
    ...
    <script>
        ...
        $.each($('#fitem_id_reportfrom > select'),function(){
        ...
        $('#coursesubmit').click(function(e) {
            ...
            document.location.href = "<?php echo $CFG->wwwroot;?>/report/qmplus/zipGenerator.php?report=coursefiles&val="+
            $('#course').val()+"&datefrom="+datefrom+"&dateto="+dateto;
