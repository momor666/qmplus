...
require(dirname(__FILE__).'/configlog_form.php');
...
if (has_capability('report/qmplus:view', context_system::instance())) {
    ...
    $mform = new report_qmplus_configlog_form();
...
?>
    ...
    <script>
        ...
        $('#configlogsubmit').click(function(e) {
            e.preventDefault();
            ...
            document.location.href = "<?php echo $CFG->wwwroot;?>/report/qmplus/zipGenerator.php?report=configlog&datefrom="
