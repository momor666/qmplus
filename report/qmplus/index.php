 ...
 * @editor     Vasileios Sotiras <v.sotiras@qmul.ac.uk>
...
//require_capability('report/qmplus:view', context_system::instance());
...
if (has_capability('report/qmplus:view', context_system::instance())) {
    ...
    $mform = new report_qmplus_media_form();
...
?>
    ...
    <script>
        ...
        $('#mimesubmit').click(function(e) {
            ...
            document.location.href = "<?php echo $CFG->wwwroot;?>/report/qmplus/zipGenerator.php?report=mime&val="+
                        $('#mime').val()+"&datefrom="+datefrom+"&dateto="+dateto;
        });
