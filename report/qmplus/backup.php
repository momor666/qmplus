...
require(dirname(__FILE__).'/backup_form.php');
...
if (has_capability('report/qmplus:view', context_system::instance())) {
    ...
    $mform = new report_qmplus_backup_form();
...
?>
    ...
    <script>
        ...
        $('#backupsubmit').click(function(e) {
            ...
            document.location.href = "<?php echo $CFG->wwwroot;?>/report/qmplus/zipGenerator.php?report=coursebackup&datefrom="
