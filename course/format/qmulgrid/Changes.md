...
Version 3.2.1.0
  ...
  2. Remove old 'format_qmulgrid_delete_course' function and replace with '\core\event\course_content_deleted' event.
...
Version 2.9.1.4.
  ...
  2. Delete format_qmulgrid_icon record when a section is deleted.
...
5th November 2014 Version 2.7.1.4
  ...
  4. Fixed section 0 editing drop down in Bootstrap v3 themes: https://github.com/gjb2048/moodle-format_qmulgrid/issues/9.
...
Change by G J Barnard
  1. Fix to RTL CSS thanks to Nadav Kavalerchik - https://github.com/gjb2048/moodle-courseformat_qmulgrid/pull/3 being:
...
Change by G J Barnard
  ...
  2. Fixed issue reported by Graham Woodsford whereby teachers could not create Collapsed Topics courses.  The code in the area
     ...
     'format/qmulgrid:changeimagecontainersize', 'format/qmulgrid:changeimageresizemethod' and 'format/qmulgrid:changeimagecontainerstyle'
...
been an issue as there should be no records in the 'format_qmulgrid_icon' table for course id '1', but
...
Change by G J Barnard
  1. Fix incorrect detection of non-existent entry in format_qmulgrid_icon table.  Thanks to
...
Change by G J Barnard
  ...
  5. Fixed an issue when deleting a course that was not in the grid format where
     the function 'format_qmulgrid_delete_course' in 'lib.php' was being called even
