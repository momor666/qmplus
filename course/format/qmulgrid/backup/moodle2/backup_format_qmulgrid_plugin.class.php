 ...
 */
class backup_format_qmulgrid_plugin extends backup_format_plugin {
    ...
    protected function define_course_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, '/course/format', 'qmulgrid');
        ...
        $plugin->add_child($plugindimension);

        // Set source to populate the data.
        $pluginwrapper->set_source_table('format_qmulgrid_summary', array(
    ...
    protected function define_section_plugin_structure() {
        ...
        // Define the virtual plugin element with the condition to fulfill.
        $plugin = $this->get_plugin_element(null, $this->get_format_condition(), 'qmulgrid');
        ...
        // Set source to populate the data.
        $pluginwrapper->set_source_table('format_qmulgrid_icon', array(
