...
$string['pluginname'] = 'Grid format (QMUL)';
...
// Capabilities.
$string['qmulgrid:changeimagecontaineralignment'] = 'Change or reset the image container alignment';
$string['qmulgrid:changeimagecontainersize'] = 'Change or reset the image container size';
$string['qmulgrid:changeimageresizemethod'] = 'Change or reset the image resize method';
$string['qmulgrid:changeimagecontainerstyle'] = 'Change or reset the image container style';
$string['qmulgrid:changesectiontitleoptions'] = 'Change or reset the section title options';
