 ...
 * @namespace
 */
M.format_qmulgrid = M.format_qmulgrid || {
 ...
 */
M.format_qmulgrid.init = function(Y, the_editing_on, the_section_redirect, the_num_sections, the_shadebox_shown_array) {
    "use strict";
    this.ourYUI = Y;
    ...
    Y.use('json-parse', function (Y) {
        M.format_qmulgrid.shadebox_shown_array = Y.JSON.parse(M.format_qmulgrid.shadebox_shown_array);
    });
    ...
    if (the_editing_on) {
        ...
        var navdrawer = M.format_qmulgrid.ourYUI.one('[data-region="drawer"] nav:first-child'); // Flat navigation.
        if (navdrawer) {
        ...
        M.format_qmulgrid.shadebox_overlay = document.getElementById('gridshadebox_overlay');
        if (M.format_qmulgrid.shadebox_overlay) {
            M.format_qmulgrid.shadebox.initialize_shadebox();
            M.format_qmulgrid.shadebox.update_shadebox();
    ...
    if ((window.location.hash) && (!the_editing_on)) {
        ...
        var min = 1;
        if (M.format_qmulgrid.shadebox_shown_array[0] == 2) { // Section 0 can be shown.
            min = 0;
        }
        if ((idx >= min) && (idx <= this.num_sections) && (M.format_qmulgrid.shadebox_shown_array[idx] == 2)) {
            M.format_qmulgrid.tab(idx);
            M.format_qmulgrid.grid_toggle();
        }
    }
};
 ...
 */
M.format_qmulgrid.icon_click = function(e) {
    "use strict";
    e.preventDefault();
 ...
 */
M.format_qmulgrid.navdrawerclick = function(e) {
    "use strict";
 ...
 */
M.format_qmulgrid.tab = function(index) {
    "use strict";
    this.ourYUI.log('M.format_qmulgrid.tab: ' + index);
    var previous_no = this.selected_section_no;
    this.selected_section_no = index;
    this.update_selected_background(previous_no);
    if (M.format_qmulgrid.shadebox.shadebox_open === true) {
         this.change_shown();
    }
};
 ...
 */
M.format_qmulgrid.icon_toggle = function(e) {
    "use strict";
    e.preventDefault();
    this.grid_toggle();
};

M.format_qmulgrid.grid_toggle = function() {
    if (this.selected_section_no != -1) { // Then a valid shown section has been selected.
        ...
        } else if (M.format_qmulgrid.shadebox.shadebox_open === true) {
 ...
 * @param {Object} e Event object.
 */
M.format_qmulgrid.previous_section = function() {
    "use strict";
 ...
 * @param {Object} e Event object.
 */
M.format_qmulgrid.next_section = function() {
 ...
 */
M.format_qmulgrid.change_selected_section = function(increase_section) {
    "use strict";
    if (this.selected_section_no != -1) { // Then a valid shown section has been selected.
 ...
 */
M.format_qmulgrid.change_shown = function() {
    "use strict";
 ...
 */
M.format_qmulgrid.set_selected_section = function(starting_point, increase_section, initialise) {
    "use strict";
 ...
 */
M.format_qmulgrid.update_selected_background = function(previous_no) {
    "use strict";
 ...
 */
M.format_qmulgrid.find_next_shown_section = function(starting_point, increase_section) {
    "use strict";
    var found = false;
...
M.format_qmulgrid.shadebox = M.format_qmulgrid.shadebox || {
...
M.format_qmulgrid.shadebox.initialize_shadebox = function() {
    "use strict";
    ...
    var gridshadebox_content = M.format_qmulgrid.ourYUI.one('#gridshadebox_content');
    if (gridshadebox_content.hasClass('absolute')) {
        var top = 50;
        var pageelement = M.format_qmulgrid.ourYUI.one('#page'); // Boost theme.
        if (!pageelement) {
            pageelement = M.format_qmulgrid.ourYUI.one('#region-main');
        }
        if (pageelement) {
        ...
        var navdrawer = M.format_qmulgrid.ourYUI.one('#nav-drawer'); // Boost theme.
        if (navdrawer) {
...
M.format_qmulgrid.shadebox.toggle_shadebox = function() {
    "use strict";
...
// Shows the shade box.
M.format_qmulgrid.shadebox.show_shadebox = function() {
    "use strict";
...
// Hides the shade box.
M.format_qmulgrid.shadebox.hide_shadebox = function() {
    "use strict";
...
M.format_qmulgrid.shadebox.update_shadebox = function() {
    "use strict";
 ...
 * Author unknown.
 */
M.format_qmulgrid.shadebox.get_page_height = function() {
    "use strict";
    var yScroll;
