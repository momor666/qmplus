...
require_once($CFG->dirroot . '/course/format/qmulgrid/editimage_form.php');
...
$url = new moodle_url('/course/format/qmulgrid/editimage.php', array(
    'contextid' => $contextid,
    'id' => $id,
...
$PAGE->set_title(get_string('editimage', 'format_qmulgrid'));
$PAGE->set_url($url);
