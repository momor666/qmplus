 ...
 */
// Instructions.
// 1.  Ensure this file and the image '515-797no09sa.jpg' are in the Moodle installation folder '/course/format/qmulgrid/test'.
...
// 3.2 In another tab of the same browser navigate to 'your moodle installation'/course/format/qmulgrid/test/test_image.php.
//     E.g. http://localhost/moodlegjb/course/format/qmulgrid/test/test_image.php.
// Success: Image shows.
...
require_once($CFG->dirroot . '/course/format/qmulgrid/lib.php'); // For format_qmulgrid.
...
$filepath = $CFG->dirroot . '/course/format/qmulgrid/test/' . $imagefilename;
...
$src = $CFG->wwwroot . '/course/format/qmulgrid/test/' . $imagefilename;
...
$ratios = format_qmulgrid::get_image_container_ratios();
$resizemethods = array(
