...
function grid_get_courseids() {
    ...
    if (!$courseids = $DB->get_records('format_qmulgrid_icon', null, '', 'courseid')) {
        $courseids = false;
    }
    return $courseids;
}
...
function grid_get_icons($courseid) {
    ...
    if (!$sectionicons = $DB->get_records('format_qmulgrid_icon', array('courseid' => $courseid), '', 'sectionid, image')) {
        $sectionicons = false;
    }
    return $sectionicons;
}
...
if ($courseids) {
    ...
    echo('<p>Cannot get list of course ids from format_qmulgrid_icon table.</p>');
    error_log('Cannot get list of course ids from format_qmulgrid_icon table.');
}
