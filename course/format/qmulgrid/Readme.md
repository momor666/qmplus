...
[![Build Status](https://travis-ci.org/gjb2048/moodle-format_qmulgrid.svg?branch=master)](https://travis-ci.org/gjb2048/moodle-format_qmulgrid)
...
The primary source for downloading this branch of the format is https://moodle.org/plugins/view.php?plugin=format_qmulgrid
with 'Select Moodle version:' set at 'Moodle 3.2'.

The secondary source is a tagged version with the v3.2 prefix on https://github.com/gjb2048/moodle-courseformat_qmulgrid/tags

If you download from the development area - https://github.com/gjb2048/moodle-courseformat_qmulgrid/ - consider that
...
https://github.com/gjb2048/moodle-courseformat_qmulgrid and doing a 'Pull Request' so that the rest of the
...
4. In the database, remove the row with the 'plugin' of 'format_qmulgrid' and 'name' of 'version' in the 'config_plugins' table
   and drop the 'format_qmulgrid_icon' and 'format_qmulgrid_summary' tables.
5. Put Moodle out of Maintenance Mode.
...
3. Change the URL to have from the root of your Moodle installation: /course/format/qmulgrid/upgrade/convert_legacy_image.php -
   i.e: http://www.mysite.com/moodle/course/format/qmulgrid/upgrade/convert_legacy_image.php
   If you wish to crop instead of scaling the images then append '?crop=1' to the end of the URL like so:
   http://www.mysite.com/moodle/course/format/qmulgrid/upgrade/convert_legacy_image.php?crop=1
   If you wish to get the full log output then append '?logverbose=1' to the end of the URL like so:
   http://www.mysite.com/moodle/course/format/qmulgrid/upgrade/convert_legacy_image.php?logverbose=1
   or with crop:
   http://www.mysite.com/moodle/course/format/qmulgrid/upgrade/convert_legacy_image.php?logverbose=1&crop=1
...
6. I'm not sure of the security vulnerabilities of the script on the server so after you have used it and are confident of the
   results then move it from the '/course/format/qmulgrid/upgrade/' folder to a safe non-served folder.
...
4.1 In the database, remove the row with the 'plugin' of 'format_qmulgrid' and 'name' of 'version' in the 'config_plugins' table
    and drop the 'format_qmulgrid_icon' and 'format_qmulgrid_summary' tables.  If automatic 'Purge all caches' appears not to work by
    lack of display etc. then perform a manual 'Purge all caches' under 'Home -> Site administration -> Development ->
    Purge all caches'.
4.2 In the database, change the row with the 'plugin' of 'format_qmulgrid' and 'name' of 'version' in the 'config_plugins' table
...
https://moodle.org/plugins/view.php?plugin=format_qmulgrid.  It is also essential that you are operating the required version of Moodle
...
https://github.com/gjb2048/moodle-format_qmulgrid/issues/23
...
the YUI module into 'yui/build/moodle-format_qmulgrid-gridkeys' and place a back port minified version in '/yui/gridkeys' for
...
$PAGE->requires->yui_module('moodle-format_qmulgrid-gridkeys', 'M.format_qmulgrid.gridkeys.init', null, null, true);
...
grid/backup/moodle2/backup_format_qmulgrid_plugin.class.php
grid/backup/moodle2/restore_format_qmulgrid_plugin.class.php
