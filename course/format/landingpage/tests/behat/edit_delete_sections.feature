@format @format_landingpage
Feature: Sections can be edited and deleted in landingpage format
  ...
  Scenario: View the default name of the general section in landingpage format
    When I click on "Edit section" "link" in the "li#section-0" "css_element"
    Then I should see "Use default section name [General]"

  Scenario: Edit the default name of the general section in landingpage format
    When I click on "Edit section" "link" in the "li#section-0" "css_element"
  ...
  @javascript
  Scenario: Inline edit section name in landingpage format
  ...
  Scenario: Deleting the last section in landingpage format
  ...
  Scenario: Deleting the middle section in landingpage format
  ...
  Scenario: Deleting the orphaned section in landingpage format
  ...
  Scenario: Deleting a section when orphaned section is present in landingpage format
    When I follow "Reduce the number of sections"
    Then I should see "Orphaned activities (section 5)" in the "li#section-5" "css_element"
