...
$string['nameqmultc'] = 'QMUL Collapsed Topics';
$string['formatqmultc'] = 'QMUL Collapsed Topics';

// Used in format.php.
$string['qmultctoggle'] = 'Toggle';
$string['qmultcsidewidthlang'] = 'en-28px';

// Toggle all - Moodle Tracker CONTRIB-3190.
$string['qmultcall'] = 'sections.';  // Leave as AMOS maintains only the latest translation - so previous versions are still supported.
$string['qmultcopened'] = 'Open all';
$string['qmultcclosed'] = 'Close all';

// Moodle 2.0 Enhancement - Moodle Tracker MDL-15252, MDL-21693 & MDL-22056 - http://docs.moodle.org/en/Development:Languages.
$string['sectionname'] = 'Section';
$string['pluginname'] = 'Collapsed Topics (QMUL)';
$string['section0name'] = 'General';

// MDL-26105.
$string['page-course-view-qmultc'] = 'Any course main page in the collapsed topics format';
$string['page-course-view-qmultc-x'] = 'Any course page in the collapsed topics format';
...
// Capabilities.
$string['qmultc:changelayout'] = 'Change or reset the layout';
$string['qmultc:changecolour'] = 'Change or reset the colour';
$string['qmultc:changetogglealignment'] = 'Change or reset the toggle alignment';
$string['qmultc:changetoggleiconset'] = 'Change or reset the toggle icon set';
