 ...
 * @namespace
 */
M.format_qmultc = M.format_qmultc || {};
...
M.format_qmultc.thesparezeros = "00000000000000000000000000";
M.format_qmultc.togglestate = false;
M.format_qmultc.courseid = 0;
M.format_qmultc.togglePersistence = 1; // Toggle persistence - 1 = on, 0 = off.
M.format_qmultc.ourYUI = false;
M.format_qmultc.numSections = 0;
M.format_qmultc.userIsEditing = false;

// Namespace constants:....
M.format_qmultc.TOGGLE_6 = 1;
M.format_qmultc.TOGGLE_5 = 2;
M.format_qmultc.TOGGLE_4 = 4;
M.format_qmultc.TOGGLE_3 = 8;
M.format_qmultc.TOGGLE_2 = 16;
M.format_qmultc.TOGGLE_1 = 32;
 ...
 */
M.format_qmultc.init = function(Y, theCourseId, theToggleState, theNumSections, theTogglePersistence,
    ...
    for (var togi = 1; togi <= this.numSections; togi++) {
        ...
        var toggle = Y.one("ul.qmulctopics #toggle-" + togi);
        if (toggle) {
...
M.format_qmultc.toggleClick = function(e) {
...
M.format_qmultc.allOpenClick = function(e) {
    e.preventDefault();
    M.format_qmultc.ourYUI.all(".toggledsection").addClass('sectionopen');
    M.format_qmultc.ourYUI.all(".toggle span.the_toggle").addClass('toggle_open').removeClass('toggle_closed')
        .setAttribute('aria-pressed', 'true');
    M.format_qmultc.resetState(M.format_qmultc.get_max_digit());
    M.format_qmultc.save_toggles();
};

M.format_qmultc.allCloseClick = function(e) {
    e.preventDefault();
    M.format_qmultc.ourYUI.all(".toggledsection").removeClass('sectionopen');
    M.format_qmultc.ourYUI.all(".toggle span.the_toggle").addClass('toggle_closed').removeClass('toggle_open')
        .setAttribute('aria-pressed', 'false');
    M.format_qmultc.resetState(M.format_qmultc.get_min_digit());
    M.format_qmultc.save_toggles();
};

M.format_qmultc.resetState = function(dchar) {
    M.format_qmultc.togglestate = "";
    var numdigits = M.format_qmultc.get_required_digits(M.format_qmultc.numSections);
    for (var i = 0; i < numdigits; i++) {
        M.format_qmultc.togglestate += dchar;
    }
};

// Toggle functions
// Args - targetNode that initiated the call, toggleNum the number of the toggle.
M.format_qmultc.toggle_topic = function(targetNode, toggleNum) {
    "use strict";
...
M.format_qmultc.to2baseString = function(thirtysix) {
    "use strict";
...
M.format_qmultc.save_toggles = function() {
    "use strict";
    if (this.togglePersistence == 1) { // Toggle persistence - 1 = on, 0 = off.
        M.format_qmultc.set_user_preference('qmultc_toggle_' + this.courseid, this.togglestate);
    }
};

// New base 64 code:....
M.format_qmultc.is_old_preference = function(pref) {
    "use strict";
    var retr = false;
...
M.format_qmultc.convert_to_new_preference = function() {
    "use strict";
 ...
 */
M.format_qmultc.set_toggle_state = function(togglenum, state) {
    "use strict";
...
M.format_qmultc.get_required_digits = function(numtoggles) {
    "use strict";
    return this.get_toggle_pos(numtoggles);
};

M.format_qmultc.get_toggle_pos = function(togglenum) {
    "use strict";
    return Math.ceil(togglenum / 6);
};

M.format_qmultc.get_min_digit = function() {
    "use strict";
    return ':'; // ':' is 58.
};

M.format_qmultc.get_max_digit = function() {
    "use strict";
    return 'y'; // 'y' is 121.
};

M.format_qmultc.get_toggle_flag = function(togglenum, togglecharpos) {
    "use strict";
...
M.format_qmultc.decode_character_to_value = function(character) {
    "use strict";
    return character.charCodeAt(0) - 58;
};

M.format_qmultc.encode_value_to_character = function(val) {
    "use strict";
 ...
 */
M.format_qmultc.set_user_preference = function(name, value) {
    YUI().use('io', function(Y) {
        var url = M.cfg.wwwroot + '/course/format/qmultc/settopcollpref.php?sesskey=' + M.cfg.sesskey + '&pref=' + encodeURI(name) + '&value=' + encodeURI(value); // jshint ignore:line
        ...
        if (M.cfg.developerdebug) {
            cfg.on.failure = function() {
                console.log("Error updating qmultc preference '" + name + "' using AJAX.  Almost certainly your session has timed out.  Clicking this link will repeat the AJAX call that failed so you can see the error: "); // jshint ignore:line
            };
        }
